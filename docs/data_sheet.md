Data set name: PMST Moirang Mantak Kom

Data set developer(s): Kanshouwa Susie, Anja Karina Meduna, Sandra Auderset

Data sheet author(s): Kanshouwa Susie, Sandra Auderset

Others who contributed to this document: St. Timothy Kom
...
This data set was created to investigate the dynamics of person marking in Moirang Mantak Kom and other South-Central Trans-Himalayan languages.
...
For Moirang Mantak, it is a version of the community orthography used by speakers.

**How many instances are there in total?**

* Number of inflected forms: 205
* Number of unique inflected forms: 78
...
|paradigm |variants_tag |paradigm_tag  |  n|
|:--------|:------------|:-------------|--:|
|pron     |unspecified  |              |  7|
|fut.aff  |unspecified  |certain_fut   | 39|
|fut.aff  |unspecified  |uncertain_fut | 39|
|fut.neg  |unspecified  |              | 39|
|nfut.aff |unspecified  |              | 39|
|nfut.neg |unspecified  |              | 42|
...
* Glottocode: komi1270
* Language variety description: This is a variety of Kom spoken in Moirang Mantak village, located in Churachandpur district of Manipur in northeast India. The Glottocode refers to Kom in general, not specifically to the Moirang Mantak variety.

**Does the data pertain to specific dialects, geographical locations, genre, etc?**

The data was collected from Moirang Mantak village. There are six regional varieties in Kom: Mongtung variety, Sinamkom variety, Moirang variety, Mantak variety, Sagang variety, and Tonsen variety. Moirang Mantak belongs to the Mantak variety.
...
The data set pertains to small or indigenous language communities, namely those of the Moirang Mantak Kom people in Manipur.
...
St. Timothy Kom: native speaker (language consultant)
...
The data was collected predominantly between November 2025 and June 2026.
