# Person Marking in South-Central Trans-Himalayan: Moirang Mantak Kom

This PARALEX set contains person markers in Moirang Mantak Kom, including inflected verbal forms and pronouns. It constitutes part of the PMST (Person Marking in South-Central Trans-Himalayan) database.
...
## Additional information specific to Moirang Mantak Kom

* Tone: The language has tones, but they are not marked in the source form, as the tonal analysis is still pending.
* Mapping between database paradigm labels and Moirang Mantak descriptive labels based on Aimol 2007:
...
a) In future affirmative constructions, the speaker makes a distinction between certain and uncertain future. Forms with the future marker ***sik*** imply sureness/certainty, whereas forms with ***te*** imply possibility without certainty.
